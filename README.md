...
This project uses a controlled factorial experiment to evaluate whether serving methods impact soda enjoyment, and finds no significant effects across conditions.
